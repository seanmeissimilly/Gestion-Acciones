<%-- 
    Document   : reporte_accion_5
    Created on : Oct 3, 2023, 10:15:25 AM
    Author     : David Sean
--%>
...
<html lang="es">
    ...
    <head>
        ...
        <title>GesCap Comentarios de Alumnos en las Evaluaciones de Reacción</title>
            ...
            <div class="container my-4">
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <h2>Comentarios de Alumnos en las Evaluaciones de Reacción</h2>
                        <form name="form_accion" action="report_accion_5.jsp">
                            <div class="mb-3">
